 ...
 */
public class AFrameScreen extends ABasePanel
    implements WindowListener
{
     ...
     */
    public AFrameScreen(ScreenField model, boolean bEditableControl)
    {
        this();
    ...
    public Component setupControl(boolean bEditableControl)
    {
        ...
        control.setFocusTraversalPolicy(new org.jbundle.base.screen.control.android.MyFocusTraversalPolicy());
    ...
    public ScreenInfo getScreenInfo()
    {
        ...
        if (frameScreen.getAppletScreen() != null)
            return ((AScreenField)frameScreen.getAppletScreen().getScreenFieldView()).getScreenInfo();
        else
            return null;
    } // Screen information
    /**
    ...
    public Dimension getFrameSize(JFrame frame)
    {
        ...
        if (toolkit != null)
        {
            ...
            Rectangle m_dimFarthest = ((AScreenField)((BasePanel)this.getScreenField()).getSField(0).getScreenFieldView()).calcBoxShape(new Point(20, 20));
            if (dimScreen != null)
            {
