 ...
 */
public class AToggleButton extends ABaseButton
{

    /**
     * Constructor.
     */
    public AToggleButton()
    {
        super();
    }
    /**
     ...
     */
    public AToggleButton(ScreenField model, boolean bEditableControl)
    {
        this();
...
//            rect.x += -descSize.width + sizeFix;
        rect.x -= iTextWidth + org.jbundle.base.screen.control.android.util.ScreenInfo.EXTRA_COL_SPACING;
//        rect.width -= sizeFix;
        if (rect.x < 0)
            rect.x = 0;
        return rect;
