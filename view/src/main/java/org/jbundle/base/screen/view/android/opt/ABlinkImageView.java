 ...
 */
package org.jbundle.base.screen.view.android.opt;
...
import org.jbundle.base.screen.view.android.ABaseButton;
import org.jbundle.base.screen.view.android.AButtonBox;
 ...
 */
public class ABlinkImageView extends AButtonBox
{

    /**
     * Constructor.
     */
    public ABlinkImageView()
    {
        super();
    }
    /**
     ...
     */
    public ABlinkImageView(ScreenField model, boolean bEditableControl)
    {
        this();
    ...
    public Rectangle calcBoxShape(Point ptLocation)
    {
        ...
        itsSize.width = ABaseButton.DEFAULT_BUTTON_WIDTH;   // 16
        itsSize.height = Math.max(itsSize.height, ABaseButton.DEFAULT_BUTTON_HEIGHT);   // 15
