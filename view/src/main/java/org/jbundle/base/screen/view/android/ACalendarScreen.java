...
import org.jbundle.base.screen.view.android.calendar.CalendarTableModel;
 ...
 */
public class ACalendarScreen extends ABaseGridTableScreen
    implements MyListSelectionListener
{
     ...
     */
    public ACalendarScreen(ScreenField model, boolean bEditableControl)
    {
        this();
