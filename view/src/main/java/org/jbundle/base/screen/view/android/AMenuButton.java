 ...
 */
public class AMenuButton extends ACannedBox
{
     ...
     */
    public AMenuButton(ScreenField model,boolean bEditableControl)
    {
        this();
    ...
    {
//      This starting code is the same as AButtonBox, but I use JUnderlinedButtons instead of JButtons;
