 ...
 */
package org.jbundle.base.screen.view.android.menu;
 ...
 */
public class ABaseMenuBar extends ABasePanel
{
     ...
     * Constructor.
     */
    public ABaseMenuBar(ScreenField model,boolean bEditableControl)
    {
        this();
