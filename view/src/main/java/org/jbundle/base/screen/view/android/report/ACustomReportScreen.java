 ...
 */
public class ACustomReportScreen extends ABaseReportScreen
{
    /**
     ...
     */
    public ACustomReportScreen(ScreenField model, boolean bEditableControl)
    {
        this();
