 ...
 */
public class ARadioButton extends AToggleButton
{
     ...
     */
    public ARadioButton(ScreenField model, boolean bEditableControl)
    {
        this();
    ...
    public Component setupControl(boolean bEditableControl)
    {
        ...
        control.setIconTextGap(org.jbundle.base.screen.control.android.util.ScreenInfo.EXTRA_COL_SPACING);
        if (bEditableControl)
        {
