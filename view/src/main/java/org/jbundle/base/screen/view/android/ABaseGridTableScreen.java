 ...
 */
public class ABaseGridTableScreen extends ABaseGridScreen
{
    /**
     ...
     */
    public ABaseGridTableScreen(ScreenField model, boolean bEditableControl)
    {
        this();
