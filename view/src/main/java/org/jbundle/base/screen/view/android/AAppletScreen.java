...
import org.jbundle.base.screen.view.android.report.ADualReportScreen;
 ...
 */
public class AAppletScreen extends ABasePanel
{
    /**
     ...
     */
    public AAppletScreen(ScreenField model, boolean bEditableControl)
    {
        this();
...
//        		&& (applet.getHelpView().getBaseApplet() == this.getControl())
        ...
        {	// Note: Move this to view, should not access SApplet in model.
            ...
            if (!bUseSameWindow)
            	applet.setHelpView((JHtmlEditor)((ADualReportScreen)screen.getScreenFieldView()).getControl());
        }
        else
