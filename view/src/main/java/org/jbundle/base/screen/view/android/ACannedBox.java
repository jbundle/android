 ...
 */
public class ACannedBox extends AButtonBox
    implements PropertyChangeListener
{
     ...
     */
    public ACannedBox(ScreenField model, boolean bEditableControl)
    {
        this();
    ...
    public int selectCurrentRow(boolean bLockRecord)
    {
        ...
        AGridScreen vGridScreen = (AGridScreen)gridScreen.getScreenFieldView();
    ...
    {
        public boolean startEditor(ACannedBox control, String text, String schema);
    }
    /**
     * A view specific function - open a file.
     * @return True if successful.
